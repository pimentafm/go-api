...
// @Accept json
// @Produce json
// @Param request body dto.CreateProductInput true "Product details"
// @Success 201
...
// @Accept json
// @Produce json
// @Param id path string true "Product ID" Forna(uuid)
// @Success 200
// @Failure 404
// @Failure 500 {object} Error
...
// @Description Get a paginated list of products with optional sorting
// @Tags products
// @Accept json
// @Produce json
